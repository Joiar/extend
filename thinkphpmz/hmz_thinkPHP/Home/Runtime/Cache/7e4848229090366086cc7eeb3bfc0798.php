    ...
    <body>
                ...
                <div class="header-right">
                    ...
                    <div class="head-nav">
                        ...
                        <ul class="cl-effect-15">
                            <li class="active"><a href="__URL__/index">首页</a></li>
        ...
        <div class="header-bottom">
            <div class="container">
                ...
                <div class="search2">
                    <form>
                        <li class="se-rc"><input type="text" value="" onFocus="this.value = '';" onBlur="if (this.value == '') {
                                    this.value = '';
                                }"></li>
                        ...
                        <li class="su-m"> <input type="submit" value="搜索"></li>
                        <div class="clearfix"> </div>
                    </form>
                </div>
                <div class="clearfix"> </div>
            ...
            <div class="container">
                <div class="col-md-4 soccer">
                    <div class="view effect">
                        <a href="__URL__/products"><img src="__PUBLIC__/images/1.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <h4>清润天才保湿 </h4>
                </div>
                <div class="col-md-4 soccer">
                    <div class="view effect">
                        <a href="__URL__/products"><img src="__PUBLIC__/images/2.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <h4>金致臻颜经典</h4>
                </div>
                <div class="col-md-4 soccer">
                    <div class="view effect">
                        <a href="__URL__/products"><img src="__PUBLIC__/images/3.jpg" class="img-responsive" alt=""></a>
                    </div>
                    <h4>复颜抗皱紧致</h4>
                </div>
                <div class="clearfix"> </div>
        ...
        <div class="become">
            <div class="container">
                <div class="col-md-5 become-1">
                    <h4>他的独特之美SEOULISTA</h4>
                    <p>对于油类化妆品，大多数人都持有厚重、油腻、堵塞毛孔等负面印象。因此，根据不同肌肤类型和季节，对油类化妆品的评价出现了两极化严重的现象。但是最近，随着厚重、沉闷的使对于油类</p>
                    <a href="__URL__/register" class="more">加入我们</a>

                </div>
                <div class="col-md-7 become-2">
                    <img src="__PUBLIC__/images/map.png" class="img-responsive" alt="">
                </div>
                <div class="clearfix"> </div>
            </div>
        </div>
