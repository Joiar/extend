...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/css/rlstyle.css" />
...
<div class="login_div">
   ...
   登录</div><br/><br/>
	<form  action="__URL__/doLogin" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="" id="uName" value="" placeholder="&nbsp;&nbsp;用户名/手机号"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
			...
			<div class="nav login_psdNav">
				...
				<div class="col-xs-6">
					<input type="password" name="" id="uPass" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorBylogin(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
			...
			<div class="col-xs-12 login_btn_div">
                            <input type="submit" name="btnOK" class="sub_btn" value="登录" id="login" />
...
<div class="register_body">
	<div class="col-xs-12 register_title">
     <div class="vv">
    <img src="__PUBLIC__/images/logo.png"  />
    </div>
    注册</div><br/><br/>
